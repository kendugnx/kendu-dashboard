...
const commands = [
  ...
  { command: 'gas',       description: 'Current gas fees' },
  { command: 'hhi',       description: 'Current HHI concentration' },
  { command: 'volume',    description: 'Historic volume chart' },
  { command: 'snapshot',  description: '24h snapshot card' },
