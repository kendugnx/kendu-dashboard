    ...
    <div className={styles.overlay} onClick={e => e.target === e.currentTarget && onClose()}>
      <div className={styles.modal}>
        ...
        <div className={styles.actions}>
          <button className={styles.iconBtn} onClick={download} disabled={saving || sharing || loading} title="Download PNG">
            {saving
          ...
          {canShare && (
            <button className={styles.iconBtn} onClick={share} disabled={saving || sharing || loading} title="Share">
              {sharing
                ? <span className={styles.iconBtnSpinner} />
                : <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="18" height="18">
